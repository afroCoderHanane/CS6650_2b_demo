...
echo "============================================"
echo ""
echo "${YELLOW}View full dashboard:${NC}"
cd terraform
echo "$(terraform output -raw dashboard_url 2>/dev/null || echo 'Dashboard not deployed yet')"
cd - > /dev/null
echo ""
echo "${YELLOW}To monitor in real-time, run:${NC}"
